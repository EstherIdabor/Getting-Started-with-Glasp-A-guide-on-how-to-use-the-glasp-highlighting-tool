...
- **Join a community of like-minded readers and knowledge seekers**
  For each article read and highlighted on the platform. Glasp creates a community in which anyone who has read and highlighted an article can interact with others who have also read and highlighted the article. This interaction is in the form of dropping comments and replying to comments.
...
- A page to sign up using Google will come up next, click on _continue with Google_.
...
- Pin the extension(the second arrow points to the pin) so that it appears on the tool bar and is accessible anytime you want to see your highlights.
...
- When you open the Glasp Extension, you can add a tag depending on what you think the article is about. The first arrow in the image below points to the tag.
...
At the **left**, you find more options available for you to carry out on your highlights.
